...
import { Dashboard, CheckGroup, ApiCheck, AssertionBuilder } from 'checkly/constructs'  // Import the necessary classes from your library
import { smsChannel, emailChannel } from '../alert-channels'
const alertChannels = [smsChannel, emailChannel]


// Read the JSON data from the file
const data = fs.readFileSync(path.join(__dirname, '../teamA/teamA.json'), 'utf-8');
